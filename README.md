...
MultiMaid is part of the Maid Audio suite, anchored by FreeEQ8:
...
- **MultiMaid** — focused multiband dynamics, non-overlapping with the rest · [https://github.com/GareBear99/MultiMaid](https://github.com/GareBear99/MultiMaid) ← *you are here*
